...
public class ClientExampleMain {
    public static void main(String[] args) throws InterruptedException {
        ...
        ClientExampleAnnotationConfig annotationConfig = ctx.getBean(ClientExampleAnnotationConfig.class);
        ...
        ClientExampleConfig clientExampleConfig = ctx.getBean("clientExampleConfig", ClientExampleConfig.class);
